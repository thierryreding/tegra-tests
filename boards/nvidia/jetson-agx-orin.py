...
class Board(boards.Board):
    __compatible__ = ['nvidia,p3737-0000+p3701-0000','nvidia,p3737-0000+p3701-0001','nvidia,p3737-0000+p3701-0004','nvidia,p3737-0000+p3701-0005','nvidia,p3737-0000+p3701-0008']
    ...
    devices = [
        ...
        sysfs.Device(bus = 'i2c', name = '10-001a', driver = 'imx274'),
        sysfs.Device(bus = 'i2c', name = '1-0008', driver = 'ucsi_ccg'),
        ...
        sysfs.Device(bus = 'i2c', name = '8-001c', driver = 'rt5640'),
        sysfs.Device(bus = 'i2c', name = '9-001a', driver = 'imx274'),
        sysfs.Device(bus = 'mdio_bus', name = '6800000.ethernet:00', driver = 'Aquantia AQR113C'),
        ...
        sysfs.Device(bus = 'platform', name = '300000003.regulator', driver = 'reg-fixed-voltage'),
        ...
        sysfs.Device(bus = 'platform', name = '32f0000.pwm', driver = 'tegra-pwm'),
        ...
        sysfs.Device(bus = 'platform', name = '6800000.ethernet', driver = 'nvethernet'),
        ...
        sysfs.Device(bus = 'platform', name = 'c6a0000.nvpps', driver = 'nvpps'),
        ...
        sysfs.Device(bus = 'platform', name = 'scf-pmu', driver = 'scf-pmu-drv'),
    ...
    allowlist = [
        ...
        r'imx274 (9-001a|10-001a): supply vana not found, using dummy regulator',
