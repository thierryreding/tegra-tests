...
class Board(boards.Board):
    ...
    def _build_devices(self, kernel):
        ...
        yield sysfs.Device(bus = 'platform', name = '3110000.serial', driver = [ 'of_serial', 'tegra-uart' ])
        ...
        yield sysfs.Device(bus = 'platform', name = 'c340000.pwm', driver = 'tegra-pwm')
        ...
        yield sysfs.Device(bus = 'platform', name = '14140000.pcie', driver = 'tegra194-pcie')
        yield sysfs.Device(bus = 'platform', name = '14180000.pcie', driver = 'tegra194-pcie')
        ...
        yield sysfs.Device(bus = 'platform', name = '155e0000.dpaux', driver = 'tegra-dpaux')
        yield sysfs.Device(bus = 'platform', name = '15b80000.sor', driver = 'tegra-sor')
        ...
        if kernel.version < '5.9.0':
            ...
            yield sysfs.Device(bus = 'platform', name = '40000000.sysram', driver = 'sram')
        else:
        ...
        if kernel.version >= '5.10.0':
            ...
            yield sysfs.Device(bus = 'i2c', name = '1-0056', driver = 'at24')
        ...
        yield sysfs.Device(bus = 'pci', name = '0001:01:00.0', driver = 'ahci')
    ...
    def _build_allowlist(self, kernel):
        ...
        yield r'tegra-hda 3510000.hda: azx_get_response timeout, switching to polling mode:'
        yield r'tegra-host1x 13e00000.host1x: Context device 0 has no IOMMU!'
        yield r'tegra-i2c 31c0000.i2c: deferred probe timeout, ignoring dependency'
        ...
        if kernel.version >= '5.17.0':
            yield r'mmc0: running CQE recovery'
        ...
        for irq in sysfs.interrupt_get('ahci[0001:01:00.0]'):
            yield r"IRQ%s: set affinity failed\(-22\)." % irq
