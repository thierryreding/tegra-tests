...
class Board(boards.Board):
    __compatible__ = ['nvidia,p3768-0000+p3767-0003', 'nvidia,p3768-0000+p3767-0004', 'nvidia,p3768-0000+p3767-0005']
    ...
    devices = [
        ...
        sysfs.Device(bus = 'mmc', name = 'mmc0:aaaa', driver = 'mmcblk'),
