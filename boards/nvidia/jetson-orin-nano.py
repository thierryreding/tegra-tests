...
class Board(boards.Board):
    __compatible__ = 'nvidia,p3768-0000+p3767-0005'
    ...
    def _build_devices(self, kernel):
        ...
        yield sysfs.Device(bus = 'platform', name = '140a0000.pcie', driver = 'tegra194-pcie')
        ...
        yield sysfs.Device(bus = 'platform', name = '141e0000.pcie', driver = 'tegra194-pcie')
        ...
        # Linux v6.10 added support for the Tegra Security Engine on Jetson Orin Nano
        if kernel.version >= '6.10.0':
            yield sysfs.Device(bus = 'platform', name = '15820000.crypto', driver = 'tegra-se')
            yield sysfs.Device(bus = 'platform', name = '15840000.crypto', driver = 'tegra-se')
        ...
        yield i2c1.client(0x57, driver = 'at24')
        yield i2c2
    ...
    def __init__(self):
        ...
        self.eeproms['module'] = i2c1.client(0x50)
        self.eeproms['system'] = i2c1.client(0x57)
